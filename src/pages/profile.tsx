...
import { Grid, Box, Container, CssBaseline, Toolbar, Typography, Table, TableBody, TableRow, TableCell, List, ListItem } from '@mui/material'
          ...
          <Grid container spacing={4} sx={{ my: 0 }}>
              ...
              <Box sx={{ my: 2 }}>
                ...
                <Typography variant="body1">
                  <List sx={{ listStyleType: "disc", listStylePosition: "outside", ml: "1.25rem" }}>
                    ...
                    <ListItem disablePadding sx={{ display: "list-item" }}>
                      自動ビルド（GitHub Actions）、Linux x64バイナリ対応、Docker対応、Linux armhfバイナリ対応ほか
                    </ListItem>
                  </List>
                </Typography>
              </Box>
            ...
            <Grid item xs={12} md={4}>
              ...
              <Typography variant="body1">
                <List sx={{ listStyleType: "disc", listStylePosition: "outside", ml: "1.25rem" }}>
                  <ListItem disablePadding sx={{ display: "list-item" }}>
                    技育祭 ウインターハッカソンvol7 最優秀賞 「Spatial Volume Control App」（2021年2月）
                  </ListItem>
                  <ListItem disablePadding sx={{ display: "list-item" }}>
                    電気通信大学 2019年度 学生表彰（課外活動）（2020年3月）
                  </ListItem>
                  <ListItem disablePadding sx={{ display: "list-item" }}>
                    東京ゲームショウ2019 センス・オブ・ワンダーナイト BEST Technological Game Award 「UPLIGHT」（2019年9月）
                  </ListItem>
                </List>
              </Typography>
            </Grid>
