    ...
    <>
      ...
      <section className="section">
        <div className="container">
          <h1 className="title">UPLIGHT</h1>
          <p className="subtitle">全周囲ディスプレイを搭載した携帯型ゲーム機</p>
          <div className="content">
            ...
            <p>
              ...
              にて、
              <a href="https://imedia-lab.net/iml-projects/uplight/">
                UPLIGHTプロジェクト
              </a>
              として製作。
            </p>
            ...
            <p>Arduino, Unity, 3Dプリンタ, レーザ加工機などを使用した。</p>
            <p>開発メンバーとして、電装やミドルウェアほかを担当した。</p>
          </div>
        </div>
      </section>
    </>
