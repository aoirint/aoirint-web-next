...
const softwareCards: SoftwareCard[] = [
  {
    ...
    useUrl:
      "https://chrome.google.com/webstore/detail/jkncjdlhbkikihjcokpbgijggimlmmoc",
    archiveUrl: null,
  ...
  },
  {
    ...
    useUrl:
      "https://chrome.google.com/webstore/detail/cekkbogfkgichpacgbdddchpahpkmldl",
    archiveUrl: null,
  ...
  },
  {
    title: "MATV Tool",
    description:
      "マルチオーディオトラック動画ファイルの簡易編集コマンドラインツール",
    image: "/software/images/blank.png",
    imageAlt: "Blank Image",
    useUrl:
      "https://github.com/aoirint/matvtoolpy#%E3%82%A4%E3%83%B3%E3%82%B9%E3%83%88%E3%83%BC%E3%83%AB",
    archiveUrl: null,
  ...
  },
  {
    title: "PSDLayer2Dir",
    description:
      "PSDファイルのレイヤー構造＋画像をディレクトリ構造＋PNGとしてダンプするコマンドラインツール",
    image: "/software/images/blank.png",
    imageAlt: "Blank Image",
...
const dockerImageCards: SoftwareCard[] = [
  {
    ...
    description:
      "Stable Diffusion系の画像生成モデルをブラウザから操作するUI（WebUI）",
    image: "/software/images/blank.png",
    imageAlt: "Blank Image",
  ...
  },
  {
    title: "sd-scripts",
    description:
      "Stable Diffusion系の画像生成モデルのFine tuningやLoRAを訓練するスクリプト",
    image: "/software/images/blank.png",
    imageAlt: "Blank Image",
