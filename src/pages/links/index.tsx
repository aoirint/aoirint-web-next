            ...
            <div className='column is-12 my-2'>
              ...
              <table className='table'>
                <tbody>
                  ...
                  <tr>
                    <td className='is-vcentered py-4'>
                      <a href='https://pickledchair.com/'>SuitCase&apos;s Site</a>
                    </td>
              ...
              <table className='table'>
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className='is-vcentered py-4'>Python Software Foundation</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td className='is-vcentered py-4'>
                      <a href='https://developer.nvidia.com/'>NVIDIA Developer</a>
                    </td>
            ...
            <div className='column is-12 my-2'>
              ...
              <table className='table'>
                <tbody>
                  ...
                  <tr>
                    <td className='is-vcentered py-4'>
                      <a href='https://www.gynoid.co.jp/'>ガイノイド オフィシャルサイト</a>
                    </td>
